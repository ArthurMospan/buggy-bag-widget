...
function DrawingCanvas({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    import_react_konva.Stage,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_react_konva.Layer, { children: [
...
function renderShape(s) {
  ...
  if (s.type === "pin") {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_react_konva.Group, { x: s.x, y: s.y, listening: false, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react_konva.Circle, { radius: 14, fill: "#ef4444" }),
...
function ToolBtn({ active, onClick, title, children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick, title, style: {
    width: "36px",
    height: "36px",
    borderRadius: "8px",
...
function CaptureMode({ initialTool, apiKey, onSend, onCancel }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { "data-buggy-bag": "true", style: { position: "fixed", inset: 0, zIndex: 1e4, userSelect: "none" }, children: [
    screenshotUrl ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("img", { src: screenshotUrl, alt: "screenshot", style: {
      position: "absolute",
      inset: 0,
      width: "100%",
      height: "100%",
      objectFit: "cover",
      pointerEvents: "none"
    }, draggable: false }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: {
      position: "absolute",
      inset: 0,
    ...
    screenshotUrl && !pendingShape && !showSendPanel && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { "data-buggy-bag": "true", style: {
      position: "fixed",
      bottom: "24px",
      right: "24px",
      background: "white",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ToolBtn, { active: tool === "rect", onClick: () => setTool("rect"), title: "\u0412\u0438\u0434\u0456\u043B\u0438\u0442\u0438 \u043E\u0431\u043B\u0430\u0441\u0442\u044C", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("rect", { x: "3", y: "3", width: "18", height: "18", rx: "2" }) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ToolBtn, { active: tool === "arrow", onClick: () => setTool("arrow"), title: "\u0421\u0442\u0440\u0456\u043B\u043A\u0430", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M5 19L19 5" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M8 5h11v11" })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ToolBtn, { active: tool === "pin", onClick: () => setTool("pin"), title: "\u041F\u0456\u043D", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: () => setShowSendPanel(true), style: {
        height: "32px",
        padding: "0 14px",
        borderRadius: "8px",
        background: "#1f1f1f",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: onCancel, style: {
        height: "32px",
        padding: "0 10px",
        borderRadius: "8px",
    ...
    screenshotUrl && showSendPanel && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: {
      position: "fixed",
      inset: 0,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", gap: "6px", flexWrap: "wrap", marginBottom: "10px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { fontSize: "10px", fontFamily: "monospace", color: "rgba(255,255,255,0.3)", background: "rgba(255,255,255,0.05)", padding: "2px 8px", borderRadius: "4px" }, children: techContextRef.current.route }),
        techContextRef.current.component && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { fontSize: "10px", fontFamily: "monospace", color: "#a5b4fc", background: "rgba(99,102,241,0.15)", padding: "2px 8px", borderRadius: "4px" }, children: techContextRef.current.component.name }),
        techContextRef.current.networkRequests.filter((r) => r.isError).slice(0, 2).map((r, i) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { style: { fontSize: "10px", fontFamily: "monospace", color: "#fca5a5", background: "rgba(239,68,68,0.15)", padding: "2px 8px", borderRadius: "4px" }, children: [
          r.status,
          " ",
          r.url.split("/").slice(-1)[0]
        ] }, i)),
        techContextRef.current.consoleErrors.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { style: { fontSize: "10px", color: "#fcd34d", background: "rgba(245,158,11,0.15)", padding: "2px 8px", borderRadius: "4px" }, children: [
      ...
      techContextRef.current.eventLog.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { marginTop: "10px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { fontSize: "10px", fontWeight: "700", color: "rgba(255,255,255,0.3)", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: "6px" }, children: "\u041A\u0440\u043E\u043A\u0438 \u0432\u0456\u0434\u0442\u0432\u043E\u0440\u0435\u043D\u043D\u044F (\u0430\u0432\u0442\u043E)" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { background: "rgba(255,255,255,0.04)", borderRadius: "8px", padding: "8px 10px", maxHeight: "80px", overflowY: "auto" }, children: techContextRef.current.eventLog.slice(-6).map((e, i) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { fontSize: "11px", fontFamily: "monospace", color: e.type === "console_error" || e.type === "network_error" ? "#fca5a5" : "rgba(255,255,255,0.45)", lineHeight: "1.6" }, children: [
          i + 1,
          ". ",
          e.description
        ] }, i)) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", gap: "8px", marginTop: "10px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: () => setShowSendPanel(false), style: {
          padding: "9px 16px",
          borderRadius: "10px",
          fontSize: "12px",
          fontWeight: "600",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: handleSend, style: {
          flex: 1,
          padding: "9px",
          borderRadius: "10px",
          fontSize: "13px",
...
function BuggyBagInner({ apiEndpoint, apiKey, portalUrl }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
    !activeTool && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { "data-buggy-bag": "true", style: {
      position: "fixed",
      bottom: "24px",
      right: "24px",
      zIndex: 9997,
      ...
      expanded && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: {
        display: "flex",
        flexDirection: "column",
        gap: "6px",
        alignItems: "center"
      }, children: tools.map(({ tool, icon, title }) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        "button",
        {
          type: "button",
    ...
    toast && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { "data-buggy-bag": "true", style: {
      position: "fixed",
      bottom: "90px",
      right: "24px",
      zIndex: 9999,
      ...
      toast.msg,
      toast.ok && portalUrl && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        "a",
        {
          href: portalUrl,
          target: "_blank",
