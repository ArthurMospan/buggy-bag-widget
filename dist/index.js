...
\u041A\u043E\u043B\u0456\u0440: ${hex}` : `\u041A\u043E\u043B\u0456\u0440: ${hex}`);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: "10px", fontWeight: "700", color: "rgba(255,255,255,0.4)", textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: "8px" }, children: "\u0429\u043E \u0442\u0443\u0442 \u043D\u0435 \u0442\u0430\u043A?" }),
        ...
        hasEyeDropper && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { display: "flex", gap: "4px", marginTop: "6px" }, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "button",
          {
            type: "button",
            onClick: pickColor,
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("svg", { width: "10", height: "10", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M12 2a3 3 0 0 1 3 3 3 3 0 0 1-3 3 3 3 0 0 1-3-3 3 3 0 0 1 3-3z" }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m19 11-8 8-1.5 1.5a1.5 1.5 0 0 1-2.1 0l-2.9-2.9a1.5 1.5 0 0 1 0-2.1L6 14l8-8" })
              ] }),
              "\u041A\u043E\u043B\u0456\u0440"
            ]
          }
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", gap: "6px", marginTop: "8px" }, children: [
          hasSpeechRecognition ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "button",
            {
              ...
              children: listening ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("rect", { x: "6", y: "6", width: "12", height: "12", rx: "2" }) }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
...
var errorPatched = false;
function patchGlobalErrors() {
  if (errorPatched || typeof window === "undefined") return;
  errorPatched = true;
  window.addEventListener("error", (e) => {
    const message = e.message || "Unknown error";
    const source = e.filename ? `${e.filename.split("/").slice(-1)[0]}:${e.lineno}` : void 0;
  ...
  window.addEventListener("unhandledrejection", (e) => {
    ...
    const message = reason instanceof Error ? reason.message : typeof reason === "string" ? reason : JSON.stringify(reason) ?? "Unhandled rejection";
    let source;
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          !pendingShape && !showSendPanel && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: {
            position: "fixed",
            top: "16px",
            left: "50%",
          ...
          !pendingShape && !showSendPanel && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { "data-buggy-bag": "true", style: {
            position: "fixed",
            bottom: "24px",
            right: "24px",
            ...
            shapes.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: () => setShowSendPanel(true), style: { height: "32px", padding: "0 14px", borderRadius: "8px", background: "#4f46e5", color: "white", border: "none", cursor: "pointer", fontSize: "12px", fontWeight: "700" }, children: "\u0414\u0430\u043B\u0456 \u2192" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: onCancel, style: { height: "32px", padding: "0 10px", borderRadius: "8px", background: "transparent", color: "rgba(255,255,255,0.4)", border: "none", cursor: "pointer", fontSize: "14px" }, children: "\u2715" })
          ] }),
          showSendPanel && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { position: "fixed", inset: 0, background: "rgba(0,0,0,0.55)", display: "flex", alignItems: "flex-end", justifyContent: "center", paddingBottom: "24px", zIndex: 10003 }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { width: "100%", maxWidth: "480px", margin: "0 16px", background: "#1c1c1e", borderRadius: "20px", border: "1px solid rgba(255,255,255,0.1)", padding: "16px" }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", gap: "8px" }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: () => setShowSendPanel(false), disabled: sending, style: { padding: "10px 14px", borderRadius: "10px", fontSize: "12px", fontWeight: "600", background: "rgba(255,255,255,0.06)", border: "none", cursor: "pointer", color: "rgba(255,255,255,0.5)" }, children: "\u2190 \u041D\u0430\u0437\u0430\u0434" }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: handleSend, disabled: sending, style: { flex: 1, padding: "10px", borderRadius: "10px", fontSize: "13px", fontWeight: "700", background: sending ? "rgba(79,70,229,0.5)" : "#4f46e5", color: "white", border: "none", cursor: sending ? "default" : "pointer" }, children: sending ? "\u041D\u0430\u0434\u0441\u0438\u043B\u0430\u044E..." : "\u041D\u0430\u0434\u0456\u0441\u043B\u0430\u0442\u0438 \u043D\u0430 \u043F\u043E\u0440\u0442\u0430\u043B \u2192" })
            ] })
          ] }) })
        ]
      }
