      ...
      children: [
        showDashboardButton && /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            style: { opacity: 0.88 },
            children: [
              /* @__PURE__ */ jsx2(List, { size: 15, strokeWidth: 1.75 }),
              activeBugCount > 0 && /* @__PURE__ */ jsx2("span", { className: "absolute -top-1 -right-1 w-[16px] h-[16px] bg-red-500 text-white text-[9px] font-bold rounded-full flex items-center justify-center leading-none", children: activeBugCount > 9 ? "9+" : activeBugCount })
            ]
          }
        ),
        /* @__PURE__ */ jsx2(
...
function Dashboard({ isOpen, onClose, bugs, onStatusChange, aiEndpoint }) {
  ...
  return /* @__PURE__ */ jsxs10(Fragment4, { children: [
    /* @__PURE__ */ jsxs10(Dialog, { isOpen, onClose: handleClose, title: "Bug Inbox", size: "lg", children: [
      ...
      activeBugs.length > 0 && (filter === "all" || filter === "active") && /* @__PURE__ */ jsx12("div", { className: "flex items-center gap-2 mb-3 px-1", children: /* @__PURE__ */ jsxs10(
        "button",
        {
          type: "button",
          onClick: toggleAll,
          ...
          children: [
            /* @__PURE__ */ jsx12("span", { className: `w-[16px] h-[16px] rounded-[4px] border-2 flex items-center justify-center shrink-0 transition-colors ${selectedIds.size === activeBugs.length && activeBugs.length > 0 ? "bg-[#1f1f1f] border-[#1f1f1f]" : "border-[#d4d4d4]"}`, children: selectedIds.size === activeBugs.length && activeBugs.length > 0 && /* @__PURE__ */ jsx12("svg", { width: "9", height: "7", viewBox: "0 0 9 7", fill: "none", children: /* @__PURE__ */ jsx12("path", { d: "M1 3L3.5 5.5L8 1", stroke: "white", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }) }) }),
            selectedIds.size > 0 ? `\u0412\u0438\u0431\u0440\u0430\u043D\u043E ${selectedIds.size}` : "\u0412\u0438\u0431\u0440\u0430\u0442\u0438 \u0432\u0441\u0456 \u0430\u043A\u0442\u0438\u0432\u043D\u0456"
          ]
        }
      ) }),
      /* @__PURE__ */ jsx12("div", { className: "flex flex-col gap-3", children: filtered.length === 0 ? /* @__PURE__ */ jsx12("div", { className: "py-12 text-center text-[14px] text-[#9a9a9a]", children: "\u041D\u0435\u043C\u0430\u0454 \u0431\u0430\u0433\u0456\u0432 \u0443 \u0446\u044C\u043E\u043C\u0443 \u0444\u0456\u043B\u044C\u0442\u0440\u0456" }) : filtered.map((bug) => /* @__PURE__ */ jsxs10("div", { className: "flex items-start gap-2", children: [
        bug.status === "active" && /* @__PURE__ */ jsx12(
          "button",
          {
            type: "button",
            ...
            children: /* @__PURE__ */ jsx12("span", { className: `w-[16px] h-[16px] rounded-[4px] border-2 flex items-center justify-center transition-colors ${selectedIds.has(bug.id) ? "bg-[#1f1f1f] border-[#1f1f1f]" : "border-[#d4d4d4]"}`, children: selectedIds.has(bug.id) && /* @__PURE__ */ jsx12("svg", { width: "9", height: "7", viewBox: "0 0 9 7", fill: "none", children: /* @__PURE__ */ jsx12("path", { d: "M1 3L3.5 5.5L8 1", stroke: "white", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }) }) })
          }
        ),
        /* @__PURE__ */ jsx12("div", { className: bug.status === "active" ? "flex-1 min-w-0" : "flex-1 min-w-0 pl-[24px]", children: /* @__PURE__ */ jsx12(BugCard, { bug, onStatusChange }) })
      ] }, bug.id)) }),
      activeBugs.length > 0 && /* @__PURE__ */ jsx12("div", { className: "mt-6 pt-4 border-t border-[#f0f0f0]", children: /* @__PURE__ */ jsx12(
        "button",
        {
          type: "button",
...
function BuggyBagInner({ apiEndpoint, apiKey }) {
  ...
  return /* @__PURE__ */ jsxs11(Fragment5, { children: [
    ...
    mode === "capture" && /* @__PURE__ */ jsx13(CaptureMode, { onSave: handleSaveBug, onCancel: () => setMode("idle") }),
    /* @__PURE__ */ jsx13(
      Dashboard,
      {
