...
function BugIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M12 20v-9"/><path d="M6.53 9C4.6 8.8 3 7 3 5"/><path d="M6 13H2"/>
    ...
    <>
      ...
      {!activeTool && (
        <div data-buggy-bag="true" style={{
          ...
          {/* Tool buttons — appear above when expanded */}
          {expanded && (
            <div style={{
          ...
          <span style={{
            ...
            padding: '2px 6px', borderRadius: '4px', userSelect: 'none',
          }}>
            Alt+B
          </span>
...
export function BuggyBag({ apiEndpoint, apiKey, portalUrl }: BuggyBagProps = {}) {
  useEffect(() => {
    ...
    return () => { host.remove(); setTimeout(() => root.unmount(), 0); };
...
export function activateFromUrl(): void { /* handled in component */ }
